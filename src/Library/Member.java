...
public class Member extends javax.swing.JFrame {
    ...
    public Member() {
        ...
        int randomKey = (int)(Math.random()*((99999999-10000000)+1)+10000000);
        String keyString = String.valueOf(randomKey);
        jTextField2.setText(keyString);
    }    
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 130, 350, 60));
        ...
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 160, -1, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Library/login background.jpg"))); // NOI18N
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 4, 680, 450));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(!"".equals(name) && !"".equals(address)&& !"".equals(password)&& !"".equals(type)){
        
        try {
            pst = (PreparedStatement) con.prepareStatement("Insert into Member(name,address,password,type)values(?,?,?,?)");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("update Member set name = ?, address = ?, password = ? where Id = ?");
            pst.setString(1,name);
            pst.setString(2,address);
            pst.setString(3,password);
            pst.setInt(4,id);
