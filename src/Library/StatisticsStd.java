 ...
 * @author Home
 */
public class StatisticsStd extends javax.swing.JFrame {

    /**
     * Creates new form Statistics
     */
    public StatisticsStd() {
        initComponents();
        Connect();
        Statsauthor_load();
        Statsbook_load();
    ...
    public void Statsauthor_load(){
        ...
        try {
            ...
            Logger.getLogger(StatisticsStd.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StatisticsStd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StatisticsStd().setVisible(true);
            }
        });
    }
